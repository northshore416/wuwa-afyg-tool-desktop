...
- Windows 安装包直链：[WUWA AFYG Tool Setup 0.0.1.exe](https://github.com/northshore416/wuwa-afyg-tool-desktop/releases/latest/download/WUWA%20AFYG%20Tool%20Setup%200.0.1.exe)
- 便携版直链：[WUWA AFYG Tool 0.0.1.exe](https://github.com/northshore416/wuwa-afyg-tool-desktop/releases/latest/download/WUWA%20AFYG%20Tool%200.0.1.exe)
...
- `WUWA AFYG Tool Setup 0.0.1.exe`：安装版，可选择安装目录。
- `WUWA AFYG Tool 0.0.1.exe`：便携版，双击即用。
